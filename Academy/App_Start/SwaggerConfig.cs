    ...
    public class SwaggerConfig
    {
                ...
                .EnableSwagger("docs/{apiVersion}/swagger", c =>
                     {
                        ...
                        // additional fields by chaining methods off SingleApiVersion.
                         ...
                         c.IncludeXmlComments(string.Format(@"{0}\bin\Academy.XML", System.AppDomain.CurrentDomain.BaseDirectory));
        ...
        public class AddAuthorizationHeader : IOperationFilter
        {
            ...
            public void Apply(Operation operation, SchemaRegistry schemaRegistry, ApiDescription apiDescription)
            {
                ...
                {
                    description = "The authorization token. Must be in format \"bearer TOKEN\". String must have a SPACE!!!",
                    @in = "header",
                    name = "Authorization",
                    required = true,
                    type = "string",
